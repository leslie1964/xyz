          ...
          >
            ...
            <div>
              ...
              {step === 1 && (
                <div className="flex justify-end mt-2">
                  <a href="https://secure.bravera.bank/forgot" className="text-sm text-[#36C3F1] hover:underline">Forgot?</a>
                </div>
              )}
            </div>
            ...
            <div className="flex justify-between items-center text-sm">
              <div className='flex items-center gap-2'>
                ...
                <a href="https://secure.bravera.bank//enroll" className="text-[#36C3F1] hover:underline">
